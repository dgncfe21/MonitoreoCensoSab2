...
var cars_Ref = firebase.database().ref('/LAMPARAS_E2vsab');


var dataConductores = firebase.database().ref('/LAMPARAS_E2vsab');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E2sab');
